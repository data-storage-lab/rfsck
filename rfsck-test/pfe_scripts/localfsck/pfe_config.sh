...
######### repos dir 
export PFE_HOME_DIR=/home/rameshwar/assignment/grad_project/copy_scsi_tool #!!!CHANGE TO YOUR PATH TO THE REPOS 
#export PFE_SCRIPT_DIR=~/localfsck  #cp -r scsi-tool/localfsck ~/localfsck
export PFE_SCRIPT_DIR=$PFE_HOME_DIR/pfe_scripts/localfsck  
